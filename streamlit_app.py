...
st.title("📺 Samsung TV Spec HTML Generator")
st.markdown("Paste the raw spec text below:")

text = st.text_area("📝 Initial Spec Text", height=400)
...
if st.button("Generate HTML"):
    ...
    st.subheader("📋 HTML Code (Copyable)")
    # Show full HTML content in a scrollable text area
    st.text_area(
        label="Copy this HTML code",
